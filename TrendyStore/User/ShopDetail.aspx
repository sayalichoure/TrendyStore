<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="ShopDetail.aspx.cs" Inherits="TrendyStore.User.ShopDetail" %>
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4">₹1230.00</h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="media mb-4">
                                    ...
                                    <div class="media-body">
                                        <h6>Sachin Bhardwaj<small> - <i>01 Jan 2024</i></small></h6>
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <h6>₹1230.00</h6><h6 class="text-muted ml-2"><del>₹1300.00</del></h6>
                            </div>
                        </div>
