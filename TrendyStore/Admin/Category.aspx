<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="TrendyStore.Admin.Category" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="rfvCategoryName" runat="server" Dorecolor="Red" Font-Size="Small"
                ...
                <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <img width="40" src="<%# TrendyStore.Utils.getImageUrl( Eval("CategoryImageUrl")) %>" alt="image"/>
                            </td>
                            <td>
